...
function Homework()
{
    ...
    */
   var para = document.getElementById("copyright");
   para.style.backgroundColor = "#FF0";
   ...
   for (var i = 0; i < buttons.length; i++){
    buttons[i].style.backgroundColor = "#90EE90";
   }
